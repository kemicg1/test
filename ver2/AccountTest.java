 ...
 */
	...
	private static void testeMultipleDeposits() {
	...
	private static void testAccountCreationWithNameAndBalance() {
		System.out.println("-->tesetAccountCreatioinWithNameAndBalance()");
		Account a1 = new Account ("Ceasar",1000.0);
		System.out.println("balance shpuld be $1000, balance=$"+ a1.getBalance());
